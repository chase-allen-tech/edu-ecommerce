    ...
    'JWT_ISSUERS': [
        {
            ...
            'ISSUER': 'https://digitallearningsolution.net/oauth2',
...
SOCIAL_AUTH_EDX_OAUTH2_ISSUER = "https://digitallearningsolution.net"
SOCIAL_AUTH_EDX_OAUTH2_URL_ROOT = "https://digitallearningsolution.net"
SOCIAL_AUTH_EDX_OAUTH2_LOGOUT_URL = "https://digitallearningsolution.net/logout"
...
EDX_DRF_EXTENSIONS = {
    ...
    'OAUTH2_USER_INFO_URL': 'https://digitallearningsolution.net/oauth2/user_info',
...
ENTERPRISE_SERVICE_URL = 'https://digitallearningsolution.net/enterprise/'
...
BACKEND_SERVICE_EDX_OAUTH2_PROVIDER_URL = "https://digitallearningsolution.net/oauth2"
EXTRA_APPS = []
API_ROOT = None
